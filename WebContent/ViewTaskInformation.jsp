			...
			$(function(){
				...
				datagrid = $("#dg").datagrid({
					...
					columns:[[    
				        ...
				        {field:'tk_time',title:'任务次数',width:80,align:'center'},
				        {field:'tk_proportion',title:'任务比重',width:80,align:'center'}
				        /*
				        {field:'tk_title',title:'任务标题',width:80,align:'center'},
				        {field:'tk_value',title:'任务分值',width:80,align:'center'},			       
				        {field:'tk_content',title:'任务内容',width:180,align:'center'}
				        */
				    ]]
				});
