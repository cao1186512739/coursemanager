			...
			$(function(){
				...
				datagrid = $("#dg").datagrid({
					...
					columns:[[    
						...
						{field:'m_type',title:'对象类型',width:80,align:'center',editor:{type:'combobox',options:{data:[
						        {'value':'教师','text':'教师'},
								{'value':'学生','text':'学生'}]}}},							
						{field:'m_object',title:'消息类型',width:80,align:'center',editor:{type:'combobox',options:{data:[
								{'value':'通知','text':'通知'},
								{'value':'任务','text':'任务'}]}}},								
...
//						console.info(changes);
				...
				$("#tk_name").change(function() {
					...
					//var mtype = $("#tk_name").val();
					var content = "";
					$.ajax({
						url : 'message?method=FindAllScope',
						data : {"myscope":myscope},
						dataType : 'json',
						success : function(json){
							if (json.length>0) {
				...
				<form id="searchForm">
					<table class="tableForm datagrid-toolbar" style="width: 100%;height: 100%;">						
						...
						<tr style="float: left;">
							<th>消息类型</th>
							<td>
								<select id="m_object" name="m_object" style="width: 200px;">
									<option value="">请选择</option>														
